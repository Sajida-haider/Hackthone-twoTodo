...
async def get_current_user_id(
    ...
    """
    Extract and validate user ID from JWT token as string.

    This dependency is used by the chat API which needs user_id as string
    for compatibility with the AI agent and MCP tools.
